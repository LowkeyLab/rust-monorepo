//! Testing utilities for HTTP response snapshots.
//!
//! This module provides common testing utilities that can be used across different
//! test files in the application. It includes snapshot testing functionality for
//! HTTP responses with HTML content.
